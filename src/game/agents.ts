...
export const AGENTS: CircuitAgent[] = [
  ...
  },
  {
    ...
    role: "Beacon tender",
    den: "High Beacon",
    duty: "Hold Beacon hail as civic first landing. Never a lock. Kael keeps the door.",
    ...
    works: [
      { id: "hail", label: "Hold Beacon hail for first landing", result: "Beacon hail, not a lock. First landing walks. Kael keeps the door after." },
