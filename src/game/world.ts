...
import { growHubVeil } from "./hubveil";
...
import { growSpanPosts } from "./spanposts";
import { growTerracePosts } from "./terraceposts";
import { growVeinStones } from "./veinstones";
import { growHailPosts } from "./hailposts";
import { growOrchardPosts } from "./orchardposts";
import { growKilnMarks } from "./kilnmarks";
import { growRestSteles } from "./reststeles";
...
import { growCanalFound } from "./canalfound";
import { growAimJoin } from "./aimjoin";
import { growWardHail } from "./wardhail";
import { growSpanFound } from "./spanfound";
import { growFoundAim } from "./foundaim";
import { growCanalRest } from "./canalrest";
import { growAimHail } from "./aimhail";
...
export function buildWorld(): CircuitWorld {
	...
	laterOn(() => {
		...
		try { growHubVeil(group, coarse); } catch { /* samsung */ }
		...
		try { growSpanPosts(group, coarse); } catch { /* samsung */ }
		try { growTerracePosts(group, coarse); } catch { /* samsung */ }
		try { growVeinStones(group, coarse); } catch { /* samsung */ }
		try { growHailPosts(group, coarse); } catch { /* samsung */ }
		try { growOrchardPosts(group, coarse); } catch { /* samsung */ }
		try { growKilnMarks(group, coarse); } catch { /* samsung */ }
		try { growRestSteles(group, coarse); } catch { /* samsung */ }
		...
		try { growCanalFound(group, coarse); } catch { /* samsung */ }
		try { growAimJoin(group, coarse); } catch { /* samsung */ }
		try { growWardHail(group, coarse); } catch { /* samsung */ }
		try { growSpanFound(group, coarse); } catch { /* samsung */ }
		try { growFoundAim(group, coarse); } catch { /* samsung */ }
		try { growCanalRest(group, coarse); } catch { /* samsung */ }
		try { growAimHail(group, coarse); } catch { /* samsung */ }
